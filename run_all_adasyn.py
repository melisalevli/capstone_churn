...
for name, model in models.items():
    ...
    plot_curves(roc_data, pr_data, model_name=f"{name} (ADASYN)")
...
results_df.to_csv("data/run_all_results_ADASYN.csv", index=False)
print("Results saved to data/run_all_results_ADASYN.csv file.")
...
plt.title("Model Comparison (with ADASYN)")
plt.ylim(0, 1.05)
...
plt.savefig("figures/barplot_ADASYN.png")
print("Plot saved: figures/barplot_ADASYN.png")
