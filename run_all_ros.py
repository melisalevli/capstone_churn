...
X_train, y_train = apply_random_oversampler(X_train, y_train)
...
for name, model in models.items():
    ...
    plot_curves(roc_data, pr_data, model_name=f"{name} (RandomOverSampler)")
...
results_df.to_csv("data/run_all_results_ROS.csv", index=False)
print("\n Results saved to data/run_all_results_ROS.csv file.")
...
plt.title("Model Comparison (with RandomOverSampler)")
plt.ylim(0, 1.05)
...
plt.savefig("figures/barplot_ROS.png")
print("Graph saved: figures/barplot_ROS.png")
