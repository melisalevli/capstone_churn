...
from resampling.smote import apply_smote  # ← SMOTE uygulaması
...
for name, model in models.items():
    ...
    plot_curves(roc_data, pr_data, model_name=f"{name} (SMOTE)")
...
results_df.to_csv("data/run_all_results_SMOTE.csv", index=False)
print("\nResults saved to data/run_all_results_SMOTE.csv file.")
...
plt.savefig("figures/barplot_SMOTE.png")
print("Graphic saved: figures/barplot_SMOTE.png")
