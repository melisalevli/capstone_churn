...
for name, model in models.items():
    ...
    plot_curves(roc_data, pr_data, model_name=f"{name} (SMOTE+ENN)")
...
results_df.to_csv("data/run_all_results_SMOTEENN.csv", index=False)
print("\n Results saved to file data/run_all_results_SMOTEENN.csv.")
...
plt.title("Model Comparison (with SMOTE+ENN)")
plt.ylim(0, 1.05)
...
plt.savefig("figures/barplot_SMOTEENN.png")
print("Graph saved: figures/barplot_SMOTEENN.png")
